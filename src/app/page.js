          ...
          <div className="col-span-1 md:col-span-1">
            <div className="flex flex-col items-center justify-center p-4 bg-white rounded-lg shadow-md cursor-pointer">
              <img
                ...
                width="180"
              />
              <h3 className="text-lg font-semibold mt-2">Button</h3>
          ...
          <div className="col-span-1 md:col-span-1">
            <div className="flex flex-col items-center justify-center p-4 bg-white rounded-lg shadow-md cursor-pointer ">
              <img
                ...
                width="180"
              />
              <h3 className="text-lg font-semibold mt-2">Pricing</h3>
              <p className="text-gray-500">30 components</p>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 md:px-4 lg:px-6">
        <div className="container mx-auto grid grid-cols-1 gap-6 px-4 md:px-6">
          <div className="col-span-1">
            <h2 className="text-3xl font-bold tracking-tighter">Templates</h2>
            <p className="text-gray-500">
          ...
          <div className="col-span-1 grid grid-cols-1 gap-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex flex-col gap-4">
                <h3 className="text-lg font-semibold">Neo SaaS Template</h3>
                <p className="text-gray-500">
                  A modern and sleek SaaS template for your next project.
                </p>
                <Link
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex flex-col gap-4">
                ...
                <p className="text-gray-500">
                  Showcase your work in style with this creative portfolio
                  template.
                </p>
                <Link
                  className="inline-block w-fit text-sm font-semibold rounded-md bg-gray-900 px-4 py-2 text-center text-gray-50 shadow transition-colors hover:bg-gray-900/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-950 disabled:pointer-events-none disabled:opacity-50"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex flex-col gap-4">
                ...
                <p className="text-gray-500">
                  Start selling online with this feature-rich e-commerce shop
                  template.
                </p>
                <Link
                  className="inline-block w-fit text-sm font-semibold rounded-md bg-gray-900 px-4 py-2 text-center text-gray-50 shadow transition-colors hover:bg-gray-900/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-950 disabled:pointer-events-none disabled:opacity-50"
      ...
      <section className="py-12 md:px-4 lg:px-6">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 px-4 gap-6">
          ...
          <div className="col-span-1 md:col-span-1 flex flex-col items-center justify-center p-4 bg-white rounded-lg shadow-md h-full">
            ...
            <h3 className="text-lg font-semibold mt-2">Blazing Fast</h3>
            <p className="text-gray-500 leading-relaxed text-center">
              Our components are optimized for lightning-fast performance,
              ensuring your app loads quickly and responsively.
            </p>
          </div>
          <div className="col-span-1 md:col-span-1 flex flex-col items-center justify-center p-4 bg-white rounded-lg shadow-md h-full">
            <AlignCenterHorizontalIcon className="w-24 h-24" />
            <h3 className="text-lg font-semibold mt-2">Highly Customizable</h3>
            <p className="text-gray-500 leading-relaxed text-center">
              Tailor our components to match your brand&apos;s style and design
              preferences with ease.
            </p>
          </div>
          <div className="col-span-1 md:col-span-1 flex flex-col items-center justify-center p-4 bg-white rounded-lg shadow-md h-full">
            <SparklesIcon className="w-24 h-24" />
            <h3 className="text-lg font-semibold mt-2">Beautiful Design</h3>
            <p className="text-gray-500 leading-relaxed text-center">
              Our templates and components are crafted with an eye for detail,
              ensuring a visually stunning user experience.
            </p>
          </div>
        ...
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 px-4 gap-6">
          <div className="col-span-1 md:col-span-3">
            ...
            <p className="text-gray-500 text-center mt-4">
              Subscribe to our newsletter to receive the latest templates every
              two weeks.
            </p>
